...
test.describe("Intent-driven flow for intent-poc-app", () => {
  test("Behavior is verified visually for applicable sources", async ({ page }) => {
    await test.step("Color Chip", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "color-chip.png");
    ...
    await test.step("Typography Scale", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "typography-scale.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Pill Tag", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "pill-tag.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Input Field", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "input-field.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Button Set", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "button-set.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Avatar Stack", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "avatar-stack.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Status Indicator", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "status-indicator.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Spacing Scale", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "spacing-scale.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Icon List", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "icon-list.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("KPI Block", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "kpi-block.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Primary Button", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "primary-button.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Secondary Button", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "secondary-button.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Danger Button", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "danger-button.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Highlight Card", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "highlight-card.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Compact Card", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "compact-card.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Info Banner", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "info-banner.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Warning Banner", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "warning-banner.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Modal Shell", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "modal-shell.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Table Row", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "table-row.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Search Bar", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "search-bar.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Stat Tile", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "stat-tile.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Nav Tabs", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "nav-tabs.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Success Toast", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "success-toast.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Error Toast", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "error-toast.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Form Section", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "form-section.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("User List Item", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "user-list-item.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Dashboard Summary View", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "dashboard-summary-view.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("List Overview View", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "list-overview-view.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Settings Panel View", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "settings-panel-view.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Empty Results View", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "empty-results-view.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Campaign Table View", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "campaign-table-view.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Notifications Center View", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "notifications-center-view.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("User Directory View", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "user-directory-view.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Revenue KPIs View", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "revenue-kpis-view.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Onboarding Checklist View", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "onboarding-checklist-view.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Approval Queue View", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "approval-queue-view.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Audit Log View", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "audit-log-view.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Billing Overview View", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "billing-overview-view.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Analytics Overview", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "analytics-overview.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Account List Page", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "account-list-page.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Campaign Editor Page", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "campaign-editor-page.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("System Settings Page", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "system-settings-page.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Operations Center Page", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "operations-center-page.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("User Management Page", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "user-management-page.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Incident Review Page", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "incident-review-page.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Revenue Forecast Page", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "revenue-forecast-page.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
      await target.screenshot({ path: screenshotPath });
    });
    await test.step("Surface Library Index", async () => {
      ...
      const screenshotPath = path.join(screenshotRoot, "bdd/behavior-is-verified-visually-for-applicable-sources-spec", "surface-library-index.png");
      await mkdir(path.dirname(screenshotPath), { recursive: true });
